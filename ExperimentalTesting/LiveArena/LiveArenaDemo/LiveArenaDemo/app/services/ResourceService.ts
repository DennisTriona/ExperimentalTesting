module app.services {
    ...
    export class ResourceService implements app.interfaces.IResourceService {
        ...
        constructor() {
            this.selectionItems = [
                {
                    id: 0, description: "SDHL Linköping HC - HV 71", date: "24 sep. 2016 14:25", publisher: "by Linköping HC SDHL",
                ...
                {
                    id: 1, description: "SDHL IF Sundsvall Hockey - Luleå", date: "24 sep. 2016 15:25", publisher: "by Sundsvall Hockey SDHL",
                ...
                {
                    id: 2, description: "SDHL Leksands IF - AIK", date: "24 sep. 2016 15:55", publisher: "by Leksands IF SDHL",
                ...
                {
                    id: 3, description: "SDHL SDE HF - Djurgårdens IF", date: "24 sep. 2016 16:40", publisher: "by SDE Hockey SDHL",
                ...
                {
                    id: 4, description: "SDHL Brynäs IF - MODO Hockey", date: "24 sep. 2016 16:55", publisher: "by Brynäs IF SDHL",
                ...
                {
                    id: 5, description: "SDHL Brynäs IF - Luleå HF", date: "25 sep. 2016 10:55", publisher: "by Brynäs IF SDHL",
                    thumbnail_imgUrl: "https://bcstatic.azureedge.net/default-images/73924713-b216-43a9-b6ca-a0d4ae572df3-p_14445081601_06121424_large_thumbnail.jpg?sv=2014-02-14&sr=c&si=default-images&sig=adnUtvq%2F89HPIjummkv%2BTG8FDpmBw4rbz8GRXUR0jF0%3D",
                    display_imgUrl: "https://bcstatic.blob.core.windows.net/default-images/01cdb2a0-7ba5-4c0e-fcfc-8274977e046f-p_14445081601_06121424_large.jpg?sv=2014-02-14&sr=c&si=default-images&sig=adnUtvq%2F89HPIjummkv%2BTG8FDpmBw4rbz8GRXUR0jF0%3D"
                },
                {
                    id: 6, description: "SDHL Djurgårdens IF - Linköping HC", date: "27 sep. 2016 19:25", publisher: "by Djurgårdens IF SDHL",
